class SignUpsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sign_up.save
        format.html { redirect_to sign_ups_url, notice: 'Sign up was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sign_up.update(sign_up_params)
        format.html { redirect_to sign_ups_url, notice: 'Sign up was successfully updated.' }
  ...
  private
    ...
    def sign_up_params
      params.require(:sign_up).permit(:name, :password, :password_confirmation)
    end
end
